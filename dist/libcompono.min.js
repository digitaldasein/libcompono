 ...
 */}Li.styles=((t,...e)=>{const i=1===t.length?t[0]:e.reduce(((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1]),t[0]);return new Ee(i,t,we)})`
  ...
  `,Ae([yi({type:String,attribute:"main-title"})],Li.prototype,"mainTitle",void 0),Ae([yi({type:String,attribute:"sub-title"})],Li.prototype,"subTitle",void 0),Ae([yi({type:String,attribute:"author"})],Li.prototype,"author",void 0),Ae([yi({type:String,attribute:"date"})],Li.prototype,"date",void 0),Ae([yi({type:String,attribute:"url"})],Li.prototype,"url",void 0),Ae([yi({type:String,attribute:"img-url"})],Li.prototype,"imgUrl",void 0),Ae([yi({type:String,attribute:"img-src"})],Li.prototype,"imgSrc",void 0),Ae([yi({type:String,attribute:"organisation"})],Li.prototype,"organisation",void 0),Ae([yi({type:String,attribute:"organisation-url"})],Li.prototype,"organisationUrl",void 0),Ae([yi({type:String,attribute:"config-path"})],Li.prototype,"jsonConfig",void 0),Ae([yi({type:Boolean,attribute:"full"})],Li.prototype,"full",void 0),Ae([yi({type:Number,attribute:"full-scale-factor"})],Li.prototype,"fullScaleFactor",void 0),Ae([yi({type:Boolean,attribute:!1})],Li.prototype,"goToPrint",void 0),window.customElements.define("dd-slide-collection",Li);const zi=window.ShadowRoot&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Di=Symbol(),Bi=new Map;class ji{constructor(t,e){if(this._$cssResult$=!0,e!==Di)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){let t=Bi.get(this.cssText);return zi&&void 0===t&&(Bi.set(this.cssText,t=new CSSStyleSheet),t.replaceSync(this.cssText)),t}toString(){return this.cssText}}const Ii=zi?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new ji("string"==typeof t?t:t+"",Di))(e)})(t):t
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;var Vi;const Wi=window.trustedTypes,qi=Wi?Wi.emptyScript:"",Fi=window.reactiveElementPolyfillSupport,Ki={toAttribute(t,e){switch(e){case Boolean:t=t?qi:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},Ji=(t,e)=>e!==t&&(e==e||t==t),Zi={attribute:!0,type:String,converter:Ki,reflect:!1,hasChanged:Ji};class Gi extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(t){var e;null!==(e=this.l)&&void 0!==e||(this.l=[]),this.l.push(t)}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach(((e,i)=>{const s=this._$Eh(i,e);void 0!==s&&(this._$Eu.set(s,i),t.push(s))})),t}static createProperty(t,e=Zi){if(e.state&&(e.attribute=!1),this.finalize(),this.elementProperties.set(t,e),!e.noAccessor&&!this.prototype.hasOwnProperty(t)){const i="symbol"==typeof t?Symbol():"__"+t,s=this.getPropertyDescriptor(t,i,e);void 0!==s&&Object.defineProperty(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){return{get(){return this[e]},set(s){const o=this[t];this[e]=s,this.requestUpdate(t,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||Zi}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),this.elementProperties=new Map(t.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,e=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const i of e)this.createProperty(i,t[i])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const t of i)e.unshift(Ii(t))}else void 0!==t&&e.push(Ii(t));return e}static _$Eh(t,e){const i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}o(){var t;this._$Ep=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$Em(),this.requestUpdate(),null===(t=this.constructor.l)||void 0===t||t.forEach((t=>t(this)))}addController(t){var e,i;(null!==(e=this._$Eg)&&void 0!==e?e:this._$Eg=[]).push(t),void 0!==this.renderRoot&&this.isConnected&&(null===(i=t.hostConnected)||void 0===i||i.call(t))}removeController(t){var e;null===(e=this._$Eg)||void 0===e||e.splice(this._$Eg.indexOf(t)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach(((t,e)=>{this.hasOwnProperty(e)&&(this._$Et.set(e,this[e]),delete this[e])}))}createRenderRoot(){var t;const e=null!==(t=this.shadowRoot)&&void 0!==t?t:this.attachShadow(this.constructor.shadowRootOptions);return((t,e)=>{zi?t.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):e.forEach((e=>{const i=document.createElement("style"),s=window.litNonce;void 0!==s&&i.setAttribute("nonce",s),i.textContent=e.cssText,t.appendChild(i)}))})(e,this.constructor.elementStyles),e}connectedCallback(){var t;void 0===this.renderRoot&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),null===(t=this._$Eg)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostConnected)||void 0===e?void 0:e.call(t)}))}enableUpdating(t){}disconnectedCallback(){var t;null===(t=this._$Eg)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostDisconnected)||void 0===e?void 0:e.call(t)}))}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ES(t,e,i=Zi){var s,o;const r=this.constructor._$Eh(t,i);if(void 0!==r&&!0===i.reflect){const n=(null!==(o=null===(s=i.converter)||void 0===s?void 0:s.toAttribute)&&void 0!==o?o:Ki.toAttribute)(e,i.type);this._$Ei=t,null==n?this.removeAttribute(r):this.setAttribute(r,n),this._$Ei=null}}_$AK(t,e){var i,s,o;const r=this.constructor,n=r._$Eu.get(t);if(void 0!==n&&this._$Ei!==n){const t=r.getPropertyOptions(n),l=t.converter,a=null!==(o=null!==(s=null===(i=l)||void 0===i?void 0:i.fromAttribute)&&void 0!==s?s:"function"==typeof l?l:null)&&void 0!==o?o:Ki.fromAttribute;this._$Ei=n,this[n]=a(e,t.type),this._$Ei=null}}requestUpdate(t,e,i){let s=!0;void 0!==t&&(((i=i||this.constructor.getPropertyOptions(t)).hasChanged||Ji)(this[t],e)?(this._$AL.has(t)||this._$AL.set(t,e),!0===i.reflect&&this._$Ei!==t&&(void 0===this._$EC&&(this._$EC=new Map),this._$EC.set(t,i))):s=!1),!this.isUpdatePending&&s&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach(((t,e)=>this[e]=t)),this._$Et=void 0);let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),null===(t=this._$Eg)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostUpdate)||void 0===e?void 0:e.call(t)})),this.update(i)):this._$EU()}catch(t){throw e=!1,this._$EU(),t}e&&this._$AE(i)}willUpdate(t){}_$AE(t){var e;null===(e=this._$Eg)||void 0===e||e.forEach((t=>{var e;return null===(e=t.hostUpdated)||void 0===e?void 0:e.call(t)})),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(t){return!0}update(t){void 0!==this._$EC&&(this._$EC.forEach(((t,e)=>this._$ES(e,this[e],t))),this._$EC=void 0),this._$EU()}updated(t){}firstUpdated(t){}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var Qi;Gi.finalized=!0,Gi.elementProperties=new Map,Gi.elementStyles=[],Gi.shadowRootOptions={mode:"open"},null==Fi||Fi({ReactiveElement:Gi}),(null!==(Vi=globalThis.reactiveElementVersions)&&void 0!==Vi?Vi:globalThis.reactiveElementVersions=[]).push("1.3.2");const Xi=globalThis.trustedTypes,Yi=Xi?Xi.createPolicy("lit-html",{createHTML:t=>t}):void 0,ts=`lit$${(Math.random()+"").slice(9)}$`,es="?"+ts,is=`<${es}>`,ss=document,os=(t="")=>ss.createComment(t),rs=t=>null===t||"object"!=typeof t&&"function"!=typeof t,ns=Array.isArray,ls=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,as=/-->/g,ds=/>/g,hs=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,cs=/'/g,ps=/"/g,us=/^(?:script|style|textarea|title)$/i,gs=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),vs=Symbol.for("lit-noChange"),fs=Symbol.for("lit-nothing"),$s=new WeakMap,ms=ss.createTreeWalker(ss,129,null,!1);class ys{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let o=0,r=0;const n=t.length-1,l=this.parts,[a,d]=((t,e)=>{const i=t.length-1,s=[];let o,r=2===e?"<svg>":"",n=ls;for(let e=0;e<i;e++){const i=t[e];let l,a,d=-1,h=0;for(;h<i.length&&(n.lastIndex=h,a=n.exec(i),null!==a);)h=n.lastIndex,n===ls?"!--"===a[1]?n=as:void 0!==a[1]?n=ds:void 0!==a[2]?(us.test(a[2])&&(o=RegExp("</"+a[2],"g")),n=hs):void 0!==a[3]&&(n=hs):n===hs?">"===a[0]?(n=null!=o?o:ls,d=-1):void 0===a[1]?d=-2:(d=n.lastIndex-a[2].length,l=a[1],n=void 0===a[3]?hs:'"'===a[3]?ps:cs):n===ps||n===cs?n=hs:n===as||n===ds?n=ls:(n=hs,o=void 0);const c=n===hs&&t[e+1].startsWith("/>")?" ":"";r+=n===ls?i+is:d>=0?(s.push(l),i.slice(0,d)+"$lit$"+i.slice(d)+ts+c):i+ts+(-2===d?(s.push(void 0),e):c)}const l=r+(t[i]||"<?>")+(2===e?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==Yi?Yi.createHTML(l):l,s]})(t,e);if(this.el=ys.createElement(a,i),ms.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(s=ms.nextNode())&&l.length<n;){if(1===s.nodeType){if(s.hasAttributes()){const t=[];for(const e of s.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(ts)){const i=d[r++];if(t.push(e),void 0!==i){const t=s.getAttribute(i.toLowerCase()+"$lit$").split(ts),e=/([.?@])?(.*)/.exec(i);l.push({type:1,index:o,name:e[2],strings:t,ctor:"."===e[1]?Ss:"?"===e[1]?Cs:"@"===e[1]?xs:ws})}else l.push({type:6,index:o})}for(const e of t)s.removeAttribute(e)}if(us.test(s.tagName)){const t=s.textContent.split(ts),e=t.length-1;if(e>0){s.textContent=Xi?Xi.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],os()),ms.nextNode(),l.push({type:2,index:++o});s.append(t[e],os())}}}else if(8===s.nodeType)if(s.data===es)l.push({type:2,index:o});else{let t=-1;for(;-1!==(t=s.data.indexOf(ts,t+1));)l.push({type:7,index:o}),t+=ts.length-1}o++}}static createElement(t,e){const i=ss.createElement("template");return i.innerHTML=t,i}}function _s(t,e,i=t,s){var o,r,n,l;if(e===vs)return e;let a=void 0!==s?null===(o=i._$Cl)||void 0===o?void 0:o[s]:i._$Cu;const d=rs(e)?void 0:e._$litDirective$;return(null==a?void 0:a.constructor)!==d&&(null===(r=null==a?void 0:a._$AO)||void 0===r||r.call(a,!1),void 0===d?a=void 0:(a=new d(t),a._$AT(t,i,s)),void 0!==s?(null!==(n=(l=i)._$Cl)&&void 0!==n?n:l._$Cl=[])[s]=a:i._$Cu=a),void 0!==a&&(e=_s(t,a._$AS(t,e.values),a,s)),e}class As{constructor(t,e){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var e;const{el:{content:i},parts:s}=this._$AD,o=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:ss).importNode(i,!0);ms.currentNode=o;let r=ms.nextNode(),n=0,l=0,a=s[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new bs(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new Ts(r,this,t)),this.v.push(e),a=s[++l]}n!==(null==a?void 0:a.index)&&(r=ms.nextNode(),n++)}return o}m(t){let e=0;for(const i of this.v)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class bs{constructor(t,e,i,s){var o;this.type=2,this._$AH=fs,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cg=null===(o=null==s?void 0:s.isConnected)||void 0===o||o}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cg}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=_s(this,t,e),rs(t)?t===fs||null==t||""===t?(this._$AH!==fs&&this._$AR(),this._$AH=fs):t!==this._$AH&&t!==vs&&this.$(t):void 0!==t._$litType$?this.T(t):void 0!==t.nodeType?this.k(t):(t=>{var e;return ns(t)||"function"==typeof(null===(e=t)||void 0===e?void 0:e[Symbol.iterator])})(t)?this.S(t):this.$(t)}M(t,e=this._$AB){return this._$AA.parentNode.insertBefore(t,e)}k(t){this._$AH!==t&&(this._$AR(),this._$AH=this.M(t))}$(t){this._$AH!==fs&&rs(this._$AH)?this._$AA.nextSibling.data=t:this.k(ss.createTextNode(t)),this._$AH=t}T(t){var e;const{values:i,_$litType$:s}=t,o="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=ys.createElement(s.h,this.options)),s);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===o)this._$AH.m(i);else{const t=new As(o,this),e=t.p(this.options);t.m(i),this.k(e),this._$AH=t}}_$AC(t){let e=$s.get(t.strings);return void 0===e&&$s.set(t.strings,e=new ys(t)),e}S(t){ns(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const o of t)s===e.length?e.push(i=new bs(this.M(os()),this.M(os()),this,this.options)):i=e[s],i._$AI(o),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cg=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class ws{constructor(t,e,i,s,o){this.type=1,this._$AH=fs,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=fs}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,i,s){const o=this.strings;let r=!1;if(void 0===o)t=_s(this,t,e,0),r=!rs(t)||t!==this._$AH&&t!==vs,r&&(this._$AH=t);else{const s=t;let n,l;for(t=o[0],n=0;n<o.length-1;n++)l=_s(this,s[i+n],e,n),l===vs&&(l=this._$AH[n]),r||(r=!rs(l)||l!==this._$AH[n]),l===fs?t=fs:t!==fs&&(t+=(null!=l?l:"")+o[n+1]),this._$AH[n]=l}r&&!s&&this.C(t)}C(t){t===fs?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class Ss extends ws{constructor(){super(...arguments),this.type=3}C(t){this.element[this.name]=t===fs?void 0:t}}const Es=Xi?Xi.emptyScript:"";class Cs extends ws{constructor(){super(...arguments),this.type=4}C(t){t&&t!==fs?this.element.setAttribute(this.name,Es):this.element.removeAttribute(this.name)}}class xs extends ws{constructor(t,e,i,s,o){super(t,e,i,s,o),this.type=5}_$AI(t,e=this){var i;if((t=null!==(i=_s(this,t,e,0))&&void 0!==i?i:fs)===vs)return;const s=this._$AH,o=t===fs&&s!==fs||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,r=t!==fs&&(s===fs||o);o&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==i?i:this.element,t):this._$AH.handleEvent(t)}}class Ts{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){_s(this,t)}}const Ps=window.litHtmlPolyfillSupport;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var Us,ks;null==Ps||Ps(ys,bs),(null!==(Qi=globalThis.litHtmlVersions)&&void 0!==Qi?Qi:globalThis.litHtmlVersions=[]).push("2.2.6");class Hs extends Gi{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Dt=((t,e,i)=>{var s,o;const r=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:e;let n=r._$litPart$;if(void 0===n){const t=null!==(o=null==i?void 0:i.renderBefore)&&void 0!==o?o:null;r._$litPart$=n=new bs(e.insertBefore(os(),t),t,void 0,null!=i?i:{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!1)}render(){return vs}}Hs.finalized=!0,Hs._$litElement$=!0,null===(Us=globalThis.litElementHydrateSupport)||void 0===Us||Us.call(globalThis,{LitElement:Hs});const Ns=globalThis.litElementPolyfillSupport;null==Ns||Ns({LitElement:Hs}),(null!==(ks=globalThis.litElementVersions)&&void 0!==ks?ks:globalThis.litElementVersions=[]).push("3.2.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Rs=(t,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(i){i.createProperty(e.key,t)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(i){i.createProperty(e.key,t)}};function Ms(t){return(e,i)=>void 0!==i?((t,e,i)=>{e.constructor.createProperty(i,t)})(t,e,i):Rs(t,e)
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}var Ls;null===(Ls=window.HTMLSlotElement)||void 0===Ls||Ls.prototype.assignedElements;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */}Ys.styles=((t,...e)=>{const i=1===t.length?t[0]:e.reduce(((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1]),t[0]);return new ji(i,Di)})`
  ...
  `,Oi([Ms({type:String,attribute:"text-left"})],Ys.prototype,"textLeft",void 0),Oi([Ms({type:String,attribute:"img-left"})],Ys.prototype,"imgLeft",void 0),Oi([Ms({type:String,attribute:"img-left-link"})],Ys.prototype,"imgLeftLink",void 0),Oi([Ms({type:String,attribute:"text-center"})],Ys.prototype,"textCenter",void 0),Oi([Ms({type:String,attribute:"img-center"})],Ys.prototype,"imgCenter",void 0),Oi([Ms({type:String,attribute:"img-center-link"})],Ys.prototype,"imgCenterLink",void 0),Oi([Ms({type:String,attribute:"text-right"})],Ys.prototype,"textRight",void 0),Oi([Ms({type:String,attribute:"img-right"})],Ys.prototype,"imgRight",void 0),Oi([Ms({type:String,attribute:"img-right-link"})],Ys.prototype,"imgRightLink",void 0),Oi([Ms({type:String,attribute:"config-path"})],Ys.prototype,"configPath",void 0),Oi([Ms({type:String,attribute:"align-v"})],Ys.prototype,"alignVertical",void 0),Oi([Ms({type:String,attribute:"to-selector"})],Ys.prototype,"toSelector",void 0),Oi([Ms({type:String,attribute:"from-selector"})],Ys.prototype,"fromSelector",void 0),window.customElements.define("dd-footer",Ys);const eo=window.ShadowRoot&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,io=Symbol(),so=new Map;class oo{constructor(t,e){if(this._$cssResult$=!0,e!==io)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){let t=so.get(this.cssText);return eo&&void 0===t&&(so.set(this.cssText,t=new CSSStyleSheet),t.replaceSync(this.cssText)),t}toString(){return this.cssText}}const ro=eo?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new oo("string"==typeof t?t:t+"",io))(e)})(t):t
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;var no;const lo=window.trustedTypes,ao=lo?lo.emptyScript:"",ho=window.reactiveElementPolyfillSupport,co={toAttribute(t,e){switch(e){case Boolean:t=t?ao:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},po=(t,e)=>e!==t&&(e==e||t==t),uo={attribute:!0,type:String,converter:co,reflect:!1,hasChanged:po};class go extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(t){var e;null!==(e=this.l)&&void 0!==e||(this.l=[]),this.l.push(t)}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach(((e,i)=>{const s=this._$Eh(i,e);void 0!==s&&(this._$Eu.set(s,i),t.push(s))})),t}static createProperty(t,e=uo){if(e.state&&(e.attribute=!1),this.finalize(),this.elementProperties.set(t,e),!e.noAccessor&&!this.prototype.hasOwnProperty(t)){const i="symbol"==typeof t?Symbol():"__"+t,s=this.getPropertyDescriptor(t,i,e);void 0!==s&&Object.defineProperty(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){return{get(){return this[e]},set(s){const o=this[t];this[e]=s,this.requestUpdate(t,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||uo}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),this.elementProperties=new Map(t.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,e=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const i of e)this.createProperty(i,t[i])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const t of i)e.unshift(ro(t))}else void 0!==t&&e.push(ro(t));return e}static _$Eh(t,e){const i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}o(){var t;this._$Ep=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$Em(),this.requestUpdate(),null===(t=this.constructor.l)||void 0===t||t.forEach((t=>t(this)))}addController(t){var e,i;(null!==(e=this._$Eg)&&void 0!==e?e:this._$Eg=[]).push(t),void 0!==this.renderRoot&&this.isConnected&&(null===(i=t.hostConnected)||void 0===i||i.call(t))}removeController(t){var e;null===(e=this._$Eg)||void 0===e||e.splice(this._$Eg.indexOf(t)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach(((t,e)=>{this.hasOwnProperty(e)&&(this._$Et.set(e,this[e]),delete this[e])}))}createRenderRoot(){var t;const e=null!==(t=this.shadowRoot)&&void 0!==t?t:this.attachShadow(this.constructor.shadowRootOptions);return((t,e)=>{eo?t.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):e.forEach((e=>{const i=document.createElement("style"),s=window.litNonce;void 0!==s&&i.setAttribute("nonce",s),i.textContent=e.cssText,t.appendChild(i)}))})(e,this.constructor.elementStyles),e}connectedCallback(){var t;void 0===this.renderRoot&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),null===(t=this._$Eg)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostConnected)||void 0===e?void 0:e.call(t)}))}enableUpdating(t){}disconnectedCallback(){var t;null===(t=this._$Eg)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostDisconnected)||void 0===e?void 0:e.call(t)}))}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ES(t,e,i=uo){var s,o;const r=this.constructor._$Eh(t,i);if(void 0!==r&&!0===i.reflect){const n=(null!==(o=null===(s=i.converter)||void 0===s?void 0:s.toAttribute)&&void 0!==o?o:co.toAttribute)(e,i.type);this._$Ei=t,null==n?this.removeAttribute(r):this.setAttribute(r,n),this._$Ei=null}}_$AK(t,e){var i,s,o;const r=this.constructor,n=r._$Eu.get(t);if(void 0!==n&&this._$Ei!==n){const t=r.getPropertyOptions(n),l=t.converter,a=null!==(o=null!==(s=null===(i=l)||void 0===i?void 0:i.fromAttribute)&&void 0!==s?s:"function"==typeof l?l:null)&&void 0!==o?o:co.fromAttribute;this._$Ei=n,this[n]=a(e,t.type),this._$Ei=null}}requestUpdate(t,e,i){let s=!0;void 0!==t&&(((i=i||this.constructor.getPropertyOptions(t)).hasChanged||po)(this[t],e)?(this._$AL.has(t)||this._$AL.set(t,e),!0===i.reflect&&this._$Ei!==t&&(void 0===this._$EC&&(this._$EC=new Map),this._$EC.set(t,i))):s=!1),!this.isUpdatePending&&s&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach(((t,e)=>this[e]=t)),this._$Et=void 0);let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),null===(t=this._$Eg)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostUpdate)||void 0===e?void 0:e.call(t)})),this.update(i)):this._$EU()}catch(t){throw e=!1,this._$EU(),t}e&&this._$AE(i)}willUpdate(t){}_$AE(t){var e;null===(e=this._$Eg)||void 0===e||e.forEach((t=>{var e;return null===(e=t.hostUpdated)||void 0===e?void 0:e.call(t)})),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(t){return!0}update(t){void 0!==this._$EC&&(this._$EC.forEach(((t,e)=>this._$ES(e,this[e],t))),this._$EC=void 0),this._$EU()}updated(t){}firstUpdated(t){}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var vo;go.finalized=!0,go.elementProperties=new Map,go.elementStyles=[],go.shadowRootOptions={mode:"open"},null==ho||ho({ReactiveElement:go}),(null!==(no=globalThis.reactiveElementVersions)&&void 0!==no?no:globalThis.reactiveElementVersions=[]).push("1.3.2");const fo=globalThis.trustedTypes,$o=fo?fo.createPolicy("lit-html",{createHTML:t=>t}):void 0,mo=`lit$${(Math.random()+"").slice(9)}$`,yo="?"+mo,_o=`<${yo}>`,Ao=document,bo=(t="")=>Ao.createComment(t),wo=t=>null===t||"object"!=typeof t&&"function"!=typeof t,So=Array.isArray,Eo=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Co=/-->/g,xo=/>/g,To=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Po=/'/g,Uo=/"/g,ko=/^(?:script|style|textarea|title)$/i,Ho=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),No=Symbol.for("lit-noChange"),Ro=Symbol.for("lit-nothing"),Mo=new WeakMap,Lo=Ao.createTreeWalker(Ao,129,null,!1);class Oo{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let o=0,r=0;const n=t.length-1,l=this.parts,[a,d]=((t,e)=>{const i=t.length-1,s=[];let o,r=2===e?"<svg>":"",n=Eo;for(let e=0;e<i;e++){const i=t[e];let l,a,d=-1,h=0;for(;h<i.length&&(n.lastIndex=h,a=n.exec(i),null!==a);)h=n.lastIndex,n===Eo?"!--"===a[1]?n=Co:void 0!==a[1]?n=xo:void 0!==a[2]?(ko.test(a[2])&&(o=RegExp("</"+a[2],"g")),n=To):void 0!==a[3]&&(n=To):n===To?">"===a[0]?(n=null!=o?o:Eo,d=-1):void 0===a[1]?d=-2:(d=n.lastIndex-a[2].length,l=a[1],n=void 0===a[3]?To:'"'===a[3]?Uo:Po):n===Uo||n===Po?n=To:n===Co||n===xo?n=Eo:(n=To,o=void 0);const c=n===To&&t[e+1].startsWith("/>")?" ":"";r+=n===Eo?i+_o:d>=0?(s.push(l),i.slice(0,d)+"$lit$"+i.slice(d)+mo+c):i+mo+(-2===d?(s.push(void 0),e):c)}const l=r+(t[i]||"<?>")+(2===e?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==$o?$o.createHTML(l):l,s]})(t,e);if(this.el=Oo.createElement(a,i),Lo.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(s=Lo.nextNode())&&l.length<n;){if(1===s.nodeType){if(s.hasAttributes()){const t=[];for(const e of s.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(mo)){const i=d[r++];if(t.push(e),void 0!==i){const t=s.getAttribute(i.toLowerCase()+"$lit$").split(mo),e=/([.?@])?(.*)/.exec(i);l.push({type:1,index:o,name:e[2],strings:t,ctor:"."===e[1]?Io:"?"===e[1]?Wo:"@"===e[1]?qo:jo})}else l.push({type:6,index:o})}for(const e of t)s.removeAttribute(e)}if(ko.test(s.tagName)){const t=s.textContent.split(mo),e=t.length-1;if(e>0){s.textContent=fo?fo.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],bo()),Lo.nextNode(),l.push({type:2,index:++o});s.append(t[e],bo())}}}else if(8===s.nodeType)if(s.data===yo)l.push({type:2,index:o});else{let t=-1;for(;-1!==(t=s.data.indexOf(mo,t+1));)l.push({type:7,index:o}),t+=mo.length-1}o++}}static createElement(t,e){const i=Ao.createElement("template");return i.innerHTML=t,i}}function zo(t,e,i=t,s){var o,r,n,l;if(e===No)return e;let a=void 0!==s?null===(o=i._$Cl)||void 0===o?void 0:o[s]:i._$Cu;const d=wo(e)?void 0:e._$litDirective$;return(null==a?void 0:a.constructor)!==d&&(null===(r=null==a?void 0:a._$AO)||void 0===r||r.call(a,!1),void 0===d?a=void 0:(a=new d(t),a._$AT(t,i,s)),void 0!==s?(null!==(n=(l=i)._$Cl)&&void 0!==n?n:l._$Cl=[])[s]=a:i._$Cu=a),void 0!==a&&(e=zo(t,a._$AS(t,e.values),a,s)),e}class Do{constructor(t,e){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var e;const{el:{content:i},parts:s}=this._$AD,o=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:Ao).importNode(i,!0);Lo.currentNode=o;let r=Lo.nextNode(),n=0,l=0,a=s[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new Bo(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new Fo(r,this,t)),this.v.push(e),a=s[++l]}n!==(null==a?void 0:a.index)&&(r=Lo.nextNode(),n++)}return o}m(t){let e=0;for(const i of this.v)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class Bo{constructor(t,e,i,s){var o;this.type=2,this._$AH=Ro,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cg=null===(o=null==s?void 0:s.isConnected)||void 0===o||o}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cg}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=zo(this,t,e),wo(t)?t===Ro||null==t||""===t?(this._$AH!==Ro&&this._$AR(),this._$AH=Ro):t!==this._$AH&&t!==No&&this.$(t):void 0!==t._$litType$?this.T(t):void 0!==t.nodeType?this.k(t):(t=>{var e;return So(t)||"function"==typeof(null===(e=t)||void 0===e?void 0:e[Symbol.iterator])})(t)?this.S(t):this.$(t)}M(t,e=this._$AB){return this._$AA.parentNode.insertBefore(t,e)}k(t){this._$AH!==t&&(this._$AR(),this._$AH=this.M(t))}$(t){this._$AH!==Ro&&wo(this._$AH)?this._$AA.nextSibling.data=t:this.k(Ao.createTextNode(t)),this._$AH=t}T(t){var e;const{values:i,_$litType$:s}=t,o="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=Oo.createElement(s.h,this.options)),s);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===o)this._$AH.m(i);else{const t=new Do(o,this),e=t.p(this.options);t.m(i),this.k(e),this._$AH=t}}_$AC(t){let e=Mo.get(t.strings);return void 0===e&&Mo.set(t.strings,e=new Oo(t)),e}S(t){So(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const o of t)s===e.length?e.push(i=new Bo(this.M(bo()),this.M(bo()),this,this.options)):i=e[s],i._$AI(o),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cg=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class jo{constructor(t,e,i,s,o){this.type=1,this._$AH=Ro,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=Ro}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,i,s){const o=this.strings;let r=!1;if(void 0===o)t=zo(this,t,e,0),r=!wo(t)||t!==this._$AH&&t!==No,r&&(this._$AH=t);else{const s=t;let n,l;for(t=o[0],n=0;n<o.length-1;n++)l=zo(this,s[i+n],e,n),l===No&&(l=this._$AH[n]),r||(r=!wo(l)||l!==this._$AH[n]),l===Ro?t=Ro:t!==Ro&&(t+=(null!=l?l:"")+o[n+1]),this._$AH[n]=l}r&&!s&&this.C(t)}C(t){t===Ro?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class Io extends jo{constructor(){super(...arguments),this.type=3}C(t){this.element[this.name]=t===Ro?void 0:t}}const Vo=fo?fo.emptyScript:"";class Wo extends jo{constructor(){super(...arguments),this.type=4}C(t){t&&t!==Ro?this.element.setAttribute(this.name,Vo):this.element.removeAttribute(this.name)}}class qo extends jo{constructor(t,e,i,s,o){super(t,e,i,s,o),this.type=5}_$AI(t,e=this){var i;if((t=null!==(i=zo(this,t,e,0))&&void 0!==i?i:Ro)===No)return;const s=this._$AH,o=t===Ro&&s!==Ro||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,r=t!==Ro&&(s===Ro||o);o&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==i?i:this.element,t):this._$AH.handleEvent(t)}}class Fo{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){zo(this,t)}}const Ko=window.litHtmlPolyfillSupport;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var Jo,Zo;null==Ko||Ko(Oo,Bo),(null!==(vo=globalThis.litHtmlVersions)&&void 0!==vo?vo:globalThis.litHtmlVersions=[]).push("2.2.6");class Go extends go{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Dt=((t,e,i)=>{var s,o;const r=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:e;let n=r._$litPart$;if(void 0===n){const t=null!==(o=null==i?void 0:i.renderBefore)&&void 0!==o?o:null;r._$litPart$=n=new Bo(e.insertBefore(bo(),t),t,void 0,null!=i?i:{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!1)}render(){return No}}Go.finalized=!0,Go._$litElement$=!0,null===(Jo=globalThis.litElementHydrateSupport)||void 0===Jo||Jo.call(globalThis,{LitElement:Go});const Qo=globalThis.litElementPolyfillSupport;null==Qo||Qo({LitElement:Go}),(null!==(Zo=globalThis.litElementVersions)&&void 0!==Zo?Zo:globalThis.litElementVersions=[]).push("3.2.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Xo=(t,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(i){i.createProperty(e.key,t)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(i){i.createProperty(e.key,t)}};function Yo(t){return(e,i)=>void 0!==i?((t,e,i)=>{e.constructor.createProperty(i,t)})(t,e,i):Xo(t,e)
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}var tr;null===(tr=window.HTMLSlotElement)||void 0===tr||tr.prototype.assignedElements;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class ir extends class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}{constructor(t){if(super(t),this.it=Ro,t.type!==er)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===Ro||null==t)return this.ft=void 0,this.it=t;if(t===No)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this.ft;this.it=t;const e=[t];return e.raw=e,this.ft={_$litType$:this.constructor.resultType,strings:e,values:[]}}}ir.directiveName="unsafeHTML",ir.resultType=1;const sr=(t=>(...e)=>({_$litDirective$:t,values:e}))(ir),or="",rr="",nr="",lr="",ar="",dr="",hr="",cr="dd-slide-collection",pr="",ur=!1,gr=!1,vr=!1,fr=!1,$r="100%",mr="",yr="",_r="",Ar="",br="",wr="";class Sr extends Go{constructor(){super(...arguments),this.imgSrc=nr,this.mainTitle=or,this.subTitle=rr,this.author=lr,this.organisation=ar,this.organisationUrl=dr,this.date=hr,this.noDefaultMap=ur,this.centerText=vr,this.centerImg=fr,this.center=gr,this.configPath=pr,this.fromSelector=cr,this.htmlTopLeft=mr,this.htmlTopRight=yr,this.htmlMidLeft=_r,this.htmlMidRight=Ar,this.htmlBotLeft=br,this.htmlBotRight=wr,this.widthLeft=$r}makeTitlePage(){return`\n        <div class='dd-titlepage'>\n\n          \x3c!-- logo --\x3e\n          <div id="dd-titlepage-logo">\n            <img src="${this.imgSrc}" alt="dd-logo";>\n          </div>\n\n          \x3c!-- top --\x3e\n          <div class="dd-titlepage-top-l dd-titlepage-top">\n              ${this.htmlTopLeft}\n          </div>\n          <div class="dd-titlepage-top-r dd-titlepage-top">\n              ${this.htmlTopRight}\n          </div>\n\n          \x3c!-- middle --\x3e\n          <div class="dd-titlepage-mid-l dd-titlepage-middle">\n            ${this.htmlMidLeft}\n          </div>\n          <div class="dd-titlepage-mid-r dd-titlepage-middle">\n            ${this.htmlMidRight}\n          </div>\n\n          \x3c!-- bottom --\x3e\n          <div class="dd-titlepage-bot-l dd-titlepage-bottom">\n            ${this.htmlBotLeft}\n          </div>\n          <div class="dd-titlepage-bot-r dd-titlepage-bottom">\n            ${this.htmlBotRight}\n          </div>\n        </div>\n      `}_mapDefault(){(this.mainTitle||this.subTitle)&&(this.htmlMidLeft=`\n        <div class="dd-titlepage-title dd-titlepage-mid-l default">\n          <strong>${this.mainTitle}</strong>\n        </div>\n        <div class="dd-titlepage-subtitle dd-titlepage-mid-l default">\n          ${this.subTitle}\n        </div>`),(this.author||this.organisation||this.date)&&!this.htmlBotLeft&&(this.organisationUrl?this.htmlBotLeft=`\n          <div class="dd-titlepage-bot-l default">\n          <strong>${this.author}</strong>  <br>\n          <a class="dd-titlepage-org-url" href="${this.organisationUrl}">${this.organisation}</a> <br>\n          ${this.date}\n        </div>`:this.htmlBotLeft=`\n          <div class="dd-titlepage-bot-l default">\n          <strong>${this.author}</strong>  <br>\n                  ${this.organisation}     <br>\n                  ${this.date}\n        </div>`)}async setPropsFromJson(){const t=await async function(t){if(await(async t=>404!==(await fetch(t,{method:"HEAD"})).status||(console.error(`JSON config does not exist at '${t}'`),!1))(t))try{const e=await fetch(t);return await e.json()}catch(e){console.error(`Error while reading config file at ${t} \n\n ${e}`)}return{error:"Could not parse JSON config, see console for errors"}}(this.configPath);t.error?this.htmlMidLeft=`<i><b>[ERROR]</b>${t.error} </i>`:(t.title&&(this.mainTitle=t.title),t.mainTitle&&(this.mainTitle=t.mainTitle),t.subTitle&&(this.subTitle=t.subTitle),t.author&&(this.author=t.author),t.organisation&&(this.organisation=t.organisation),t.date&&(this.date=t.date),t.imgSrc&&(this.imgSrc=t.imgSrc))}injectFromSelector(){const t=document.querySelector(this.fromSelector);t&&(t.getAttribute("main-title")&&null==this.getAttribute("main-title")&&(this.mainTitle=t.getAttribute("main-title")),t.getAttribute("sub-title")&&null==this.getAttribute("sub-title")&&(this.subTitle=t.getAttribute("sub-title")),t.getAttribute("author")&&null==this.getAttribute("author")&&(this.author=t.getAttribute("author")),t.getAttribute("date")&&null==this.getAttribute("date")&&(this.date=t.getAttribute("date")),t.getAttribute("organisation")&&null==this.getAttribute("organisation")&&(this.organisation=t.getAttribute("organisation")),t.getAttribute("organisation-url")&&null==this.getAttribute("organisation-url")&&(this.organisationUrl=t.getAttribute("organisation-url")),t.getAttribute("img-src")&&null==this.getAttribute("img-src")&&(this.imgSrc=t.getAttribute("img-src")))}async firstUpdated(){if(!this.imgSrc){this.shadowRoot.querySelector("#dd-titlepage-logo").style.display="none"}(this.centerText||this.center)&&(this.style.setProperty("--titlepage-align-lsec","center"),this.style.setProperty("--titlepage-padding-left","0px"),this.style.setProperty("--titlepage-padding-right","0px"),this.style.setProperty("--titlepage-w-left","100%")),this.widthLeft!==$r&&this.style.setProperty("--titlepage-w-left",this.widthLeft),(this.centerImg||this.center)&&window.addEventListener("load",(()=>{const t=this.shadowRoot.querySelector("#dd-titlepage-logo img").clientWidth;this.style.setProperty("--titlepage-logo-left",`calc( 50% - ${t/2}px )`)}))}render(){let t="";return this.title="Titlepage",this.configPath&&this.setPropsFromJson(),this.classList.add("slide"),this.classList.add("titlepage"),this.fromSelector&&this.injectFromSelector(),this.noDefaultMap||this._mapDefault(),t+=this.makeTitlePage(),Ho`${sr(t)}`}}function Er(t,e,i,s){var o,r=arguments.length,n=r<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,s);else for(var l=t.length-1;l>=0;l--)(o=t[l])&&(n=(r<3?o(n):r>3?o(e,i,n):o(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}Sr.styles=((t,...e)=>{const i=1===t.length?t[0]:e.reduce(((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1]),t[0]);return new oo(i,io)})`
    :host {
      /* slide placeholders */
      --slide-ratio: var(--dd-slide-ratio, calc(16 / 9));
      --slide-width: var(--dd-slide-width, 1024px);
  ...
  `,to([Yo({type:String,attribute:"img-src"})],Sr.prototype,"imgSrc",void 0),to([Yo({type:String,attribute:"main-title"})],Sr.prototype,"mainTitle",void 0),to([Yo({type:String,attribute:"sub-title"})],Sr.prototype,"subTitle",void 0),to([Yo({type:String,attribute:"author"})],Sr.prototype,"author",void 0),to([Yo({type:String,attribute:"organisation"})],Sr.prototype,"organisation",void 0),to([Yo({type:String,attribute:"organisation-url"})],Sr.prototype,"organisationUrl",void 0),to([Yo({type:String,attribute:"date"})],Sr.prototype,"date",void 0),to([Yo({type:Boolean,attribute:"no-default-map"})],Sr.prototype,"noDefaultMap",void 0),to([Yo({type:Boolean,attribute:"center-text"})],Sr.prototype,"centerText",void 0),to([Yo({type:Boolean,attribute:"center-img"})],Sr.prototype,"centerImg",void 0),to([Yo({type:Boolean,attribute:"center"})],Sr.prototype,"center",void 0),to([Yo({type:String,attribute:"config-path"})],Sr.prototype,"configPath",void 0),to([Yo({type:String,attribute:"from-selector"})],Sr.prototype,"fromSelector",void 0),to([Yo({type:String,attribute:"html-top-left"})],Sr.prototype,"htmlTopLeft",void 0),to([Yo({type:String,attribute:"html-top-right"})],Sr.prototype,"htmlTopRight",void 0),to([Yo({type:String,attribute:"html-mid-left"})],Sr.prototype,"htmlMidLeft",void 0),to([Yo({type:String,attribute:"html-mid-right"})],Sr.prototype,"htmlMidRight",void 0),to([Yo({type:String,attribute:"html-bot-left"})],Sr.prototype,"htmlBotLeft",void 0),to([Yo({type:String,attribute:"html-bot-right"})],Sr.prototype,"htmlBotRight",void 0),to([Yo({type:String,attribute:"width-left"})],Sr.prototype,"widthLeft",void 0),window.customElements.define("dd-titlepage",Sr);const Cr=window.ShadowRoot&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,xr=Symbol(),Tr=new Map;class Pr{constructor(t,e){if(this._$cssResult$=!0,e!==xr)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){let t=Tr.get(this.cssText);return Cr&&void 0===t&&(Tr.set(this.cssText,t=new CSSStyleSheet),t.replaceSync(this.cssText)),t}toString(){return this.cssText}}const Ur=Cr?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new Pr("string"==typeof t?t:t+"",xr))(e)})(t):t
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;var kr;const Hr=window.trustedTypes,Nr=Hr?Hr.emptyScript:"",Rr=window.reactiveElementPolyfillSupport,Mr={toAttribute(t,e){switch(e){case Boolean:t=t?Nr:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},Lr=(t,e)=>e!==t&&(e==e||t==t),Or={attribute:!0,type:String,converter:Mr,reflect:!1,hasChanged:Lr};class zr extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(t){var e;null!==(e=this.l)&&void 0!==e||(this.l=[]),this.l.push(t)}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach(((e,i)=>{const s=this._$Eh(i,e);void 0!==s&&(this._$Eu.set(s,i),t.push(s))})),t}static createProperty(t,e=Or){if(e.state&&(e.attribute=!1),this.finalize(),this.elementProperties.set(t,e),!e.noAccessor&&!this.prototype.hasOwnProperty(t)){const i="symbol"==typeof t?Symbol():"__"+t,s=this.getPropertyDescriptor(t,i,e);void 0!==s&&Object.defineProperty(this.prototype,t,s)}}static getPropertyDescriptor(t,e,i){return{get(){return this[e]},set(s){const o=this[t];this[e]=s,this.requestUpdate(t,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||Or}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),this.elementProperties=new Map(t.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){const t=this.properties,e=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const i of e)this.createProperty(i,t[i])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const t of i)e.unshift(Ur(t))}else void 0!==t&&e.push(Ur(t));return e}static _$Eh(t,e){const i=e.attribute;return!1===i?void 0:"string"==typeof i?i:"string"==typeof t?t.toLowerCase():void 0}o(){var t;this._$Ep=new Promise((t=>this.enableUpdating=t)),this._$AL=new Map,this._$Em(),this.requestUpdate(),null===(t=this.constructor.l)||void 0===t||t.forEach((t=>t(this)))}addController(t){var e,i;(null!==(e=this._$Eg)&&void 0!==e?e:this._$Eg=[]).push(t),void 0!==this.renderRoot&&this.isConnected&&(null===(i=t.hostConnected)||void 0===i||i.call(t))}removeController(t){var e;null===(e=this._$Eg)||void 0===e||e.splice(this._$Eg.indexOf(t)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach(((t,e)=>{this.hasOwnProperty(e)&&(this._$Et.set(e,this[e]),delete this[e])}))}createRenderRoot(){var t;const e=null!==(t=this.shadowRoot)&&void 0!==t?t:this.attachShadow(this.constructor.shadowRootOptions);return((t,e)=>{Cr?t.adoptedStyleSheets=e.map((t=>t instanceof CSSStyleSheet?t:t.styleSheet)):e.forEach((e=>{const i=document.createElement("style"),s=window.litNonce;void 0!==s&&i.setAttribute("nonce",s),i.textContent=e.cssText,t.appendChild(i)}))})(e,this.constructor.elementStyles),e}connectedCallback(){var t;void 0===this.renderRoot&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),null===(t=this._$Eg)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostConnected)||void 0===e?void 0:e.call(t)}))}enableUpdating(t){}disconnectedCallback(){var t;null===(t=this._$Eg)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostDisconnected)||void 0===e?void 0:e.call(t)}))}attributeChangedCallback(t,e,i){this._$AK(t,i)}_$ES(t,e,i=Or){var s,o;const r=this.constructor._$Eh(t,i);if(void 0!==r&&!0===i.reflect){const n=(null!==(o=null===(s=i.converter)||void 0===s?void 0:s.toAttribute)&&void 0!==o?o:Mr.toAttribute)(e,i.type);this._$Ei=t,null==n?this.removeAttribute(r):this.setAttribute(r,n),this._$Ei=null}}_$AK(t,e){var i,s,o;const r=this.constructor,n=r._$Eu.get(t);if(void 0!==n&&this._$Ei!==n){const t=r.getPropertyOptions(n),l=t.converter,a=null!==(o=null!==(s=null===(i=l)||void 0===i?void 0:i.fromAttribute)&&void 0!==s?s:"function"==typeof l?l:null)&&void 0!==o?o:Mr.fromAttribute;this._$Ei=n,this[n]=a(e,t.type),this._$Ei=null}}requestUpdate(t,e,i){let s=!0;void 0!==t&&(((i=i||this.constructor.getPropertyOptions(t)).hasChanged||Lr)(this[t],e)?(this._$AL.has(t)||this._$AL.set(t,e),!0===i.reflect&&this._$Ei!==t&&(void 0===this._$EC&&(this._$EC=new Map),this._$EC.set(t,i))):s=!1),!this.isUpdatePending&&s&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach(((t,e)=>this[e]=t)),this._$Et=void 0);let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),null===(t=this._$Eg)||void 0===t||t.forEach((t=>{var e;return null===(e=t.hostUpdate)||void 0===e?void 0:e.call(t)})),this.update(i)):this._$EU()}catch(t){throw e=!1,this._$EU(),t}e&&this._$AE(i)}willUpdate(t){}_$AE(t){var e;null===(e=this._$Eg)||void 0===e||e.forEach((t=>{var e;return null===(e=t.hostUpdated)||void 0===e?void 0:e.call(t)})),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(t){return!0}update(t){void 0!==this._$EC&&(this._$EC.forEach(((t,e)=>this._$ES(e,this[e],t))),this._$EC=void 0),this._$EU()}updated(t){}firstUpdated(t){}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var Dr;zr.finalized=!0,zr.elementProperties=new Map,zr.elementStyles=[],zr.shadowRootOptions={mode:"open"},null==Rr||Rr({ReactiveElement:zr}),(null!==(kr=globalThis.reactiveElementVersions)&&void 0!==kr?kr:globalThis.reactiveElementVersions=[]).push("1.3.2");const Br=globalThis.trustedTypes,jr=Br?Br.createPolicy("lit-html",{createHTML:t=>t}):void 0,Ir=`lit$${(Math.random()+"").slice(9)}$`,Vr="?"+Ir,Wr=`<${Vr}>`,qr=document,Fr=(t="")=>qr.createComment(t),Kr=t=>null===t||"object"!=typeof t&&"function"!=typeof t,Jr=Array.isArray,Zr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Gr=/-->/g,Qr=/>/g,Xr=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Yr=/'/g,tn=/"/g,en=/^(?:script|style|textarea|title)$/i,sn=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),on=Symbol.for("lit-noChange"),rn=Symbol.for("lit-nothing"),nn=new WeakMap,ln=qr.createTreeWalker(qr,129,null,!1),an=(t,e)=>{const i=t.length-1,s=[];let o,r=2===e?"<svg>":"",n=Zr;for(let e=0;e<i;e++){const i=t[e];let l,a,d=-1,h=0;for(;h<i.length&&(n.lastIndex=h,a=n.exec(i),null!==a);)h=n.lastIndex,n===Zr?"!--"===a[1]?n=Gr:void 0!==a[1]?n=Qr:void 0!==a[2]?(en.test(a[2])&&(o=RegExp("</"+a[2],"g")),n=Xr):void 0!==a[3]&&(n=Xr):n===Xr?">"===a[0]?(n=null!=o?o:Zr,d=-1):void 0===a[1]?d=-2:(d=n.lastIndex-a[2].length,l=a[1],n=void 0===a[3]?Xr:'"'===a[3]?tn:Yr):n===tn||n===Yr?n=Xr:n===Gr||n===Qr?n=Zr:(n=Xr,o=void 0);const c=n===Xr&&t[e+1].startsWith("/>")?" ":"";r+=n===Zr?i+Wr:d>=0?(s.push(l),i.slice(0,d)+"$lit$"+i.slice(d)+Ir+c):i+Ir+(-2===d?(s.push(void 0),e):c)}const l=r+(t[i]||"<?>")+(2===e?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==jr?jr.createHTML(l):l,s]};class dn{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let o=0,r=0;const n=t.length-1,l=this.parts,[a,d]=an(t,e);if(this.el=dn.createElement(a,i),ln.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(s=ln.nextNode())&&l.length<n;){if(1===s.nodeType){if(s.hasAttributes()){const t=[];for(const e of s.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(Ir)){const i=d[r++];if(t.push(e),void 0!==i){const t=s.getAttribute(i.toLowerCase()+"$lit$").split(Ir),e=/([.?@])?(.*)/.exec(i);l.push({type:1,index:o,name:e[2],strings:t,ctor:"."===e[1]?gn:"?"===e[1]?fn:"@"===e[1]?$n:un})}else l.push({type:6,index:o})}for(const e of t)s.removeAttribute(e)}if(en.test(s.tagName)){const t=s.textContent.split(Ir),e=t.length-1;if(e>0){s.textContent=Br?Br.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],Fr()),ln.nextNode(),l.push({type:2,index:++o});s.append(t[e],Fr())}}}else if(8===s.nodeType)if(s.data===Vr)l.push({type:2,index:o});else{let t=-1;for(;-1!==(t=s.data.indexOf(Ir,t+1));)l.push({type:7,index:o}),t+=Ir.length-1}o++}}static createElement(t,e){const i=qr.createElement("template");return i.innerHTML=t,i}}function hn(t,e,i=t,s){var o,r,n,l;if(e===on)return e;let a=void 0!==s?null===(o=i._$Cl)||void 0===o?void 0:o[s]:i._$Cu;const d=Kr(e)?void 0:e._$litDirective$;return(null==a?void 0:a.constructor)!==d&&(null===(r=null==a?void 0:a._$AO)||void 0===r||r.call(a,!1),void 0===d?a=void 0:(a=new d(t),a._$AT(t,i,s)),void 0!==s?(null!==(n=(l=i)._$Cl)&&void 0!==n?n:l._$Cl=[])[s]=a:i._$Cu=a),void 0!==a&&(e=hn(t,a._$AS(t,e.values),a,s)),e}class cn{constructor(t,e){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var e;const{el:{content:i},parts:s}=this._$AD,o=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:qr).importNode(i,!0);ln.currentNode=o;let r=ln.nextNode(),n=0,l=0,a=s[0];for(;void 0!==a;){if(n===a.index){let e;2===a.type?e=new pn(r,r.nextSibling,this,t):1===a.type?e=new a.ctor(r,a.name,a.strings,this,t):6===a.type&&(e=new mn(r,this,t)),this.v.push(e),a=s[++l]}n!==(null==a?void 0:a.index)&&(r=ln.nextNode(),n++)}return o}m(t){let e=0;for(const i of this.v)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class pn{constructor(t,e,i,s){var o;this.type=2,this._$AH=rn,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cg=null===(o=null==s?void 0:s.isConnected)||void 0===o||o}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cg}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=hn(this,t,e),Kr(t)?t===rn||null==t||""===t?(this._$AH!==rn&&this._$AR(),this._$AH=rn):t!==this._$AH&&t!==on&&this.$(t):void 0!==t._$litType$?this.T(t):void 0!==t.nodeType?this.k(t):(t=>{var e;return Jr(t)||"function"==typeof(null===(e=t)||void 0===e?void 0:e[Symbol.iterator])})(t)?this.S(t):this.$(t)}M(t,e=this._$AB){return this._$AA.parentNode.insertBefore(t,e)}k(t){this._$AH!==t&&(this._$AR(),this._$AH=this.M(t))}$(t){this._$AH!==rn&&Kr(this._$AH)?this._$AA.nextSibling.data=t:this.k(qr.createTextNode(t)),this._$AH=t}T(t){var e;const{values:i,_$litType$:s}=t,o="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=dn.createElement(s.h,this.options)),s);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===o)this._$AH.m(i);else{const t=new cn(o,this),e=t.p(this.options);t.m(i),this.k(e),this._$AH=t}}_$AC(t){let e=nn.get(t.strings);return void 0===e&&nn.set(t.strings,e=new dn(t)),e}S(t){Jr(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const o of t)s===e.length?e.push(i=new pn(this.M(Fr()),this.M(Fr()),this,this.options)):i=e[s],i._$AI(o),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cg=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class un{constructor(t,e,i,s,o){this.type=1,this._$AH=rn,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=rn}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,i,s){const o=this.strings;let r=!1;if(void 0===o)t=hn(this,t,e,0),r=!Kr(t)||t!==this._$AH&&t!==on,r&&(this._$AH=t);else{const s=t;let n,l;for(t=o[0],n=0;n<o.length-1;n++)l=hn(this,s[i+n],e,n),l===on&&(l=this._$AH[n]),r||(r=!Kr(l)||l!==this._$AH[n]),l===rn?t=rn:t!==rn&&(t+=(null!=l?l:"")+o[n+1]),this._$AH[n]=l}r&&!s&&this.C(t)}C(t){t===rn?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class gn extends un{constructor(){super(...arguments),this.type=3}C(t){this.element[this.name]=t===rn?void 0:t}}const vn=Br?Br.emptyScript:"";class fn extends un{constructor(){super(...arguments),this.type=4}C(t){t&&t!==rn?this.element.setAttribute(this.name,vn):this.element.removeAttribute(this.name)}}class $n extends un{constructor(t,e,i,s,o){super(t,e,i,s,o),this.type=5}_$AI(t,e=this){var i;if((t=null!==(i=hn(this,t,e,0))&&void 0!==i?i:rn)===on)return;const s=this._$AH,o=t===rn&&s!==rn||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,r=t!==rn&&(s===rn||o);o&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==i?i:this.element,t):this._$AH.handleEvent(t)}}class mn{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){hn(this,t)}}const yn=window.litHtmlPolyfillSupport;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var _n,An;null==yn||yn(dn,pn),(null!==(Dr=globalThis.litHtmlVersions)&&void 0!==Dr?Dr:globalThis.litHtmlVersions=[]).push("2.2.6");class bn extends zr{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Dt=((t,e,i)=>{var s,o;const r=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:e;let n=r._$litPart$;if(void 0===n){const t=null!==(o=null==i?void 0:i.renderBefore)&&void 0!==o?o:null;r._$litPart$=n=new pn(e.insertBefore(Fr(),t),t,void 0,null!=i?i:{})}return n._$AI(t),n})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!1)}render(){return on}}bn.finalized=!0,bn._$litElement$=!0,null===(_n=globalThis.litElementHydrateSupport)||void 0===_n||_n.call(globalThis,{LitElement:bn});const wn=globalThis.litElementPolyfillSupport;null==wn||wn({LitElement:bn}),(null!==(An=globalThis.litElementVersions)&&void 0!==An?An:globalThis.litElementVersions=[]).push("3.2.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Sn=(t,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(i){i.createProperty(e.key,t)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(i){i.createProperty(e.key,t)}};function En(t){return(e,i)=>void 0!==i?((t,e,i)=>{e.constructor.createProperty(i,t)})(t,e,i):Sn(t,e)
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}var Cn;null===(Cn=window.HTMLSlotElement)||void 0===Cn||Cn.prototype.assignedElements;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class Tn extends class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}{constructor(t){if(super(t),this.it=rn,t.type!==xn)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===rn||null==t)return this.ft=void 0,this.it=t;if(t===on)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this.ft;this.it=t;const e=[t];return e.raw=e,this.ft={_$litType$:this.constructor.resultType,strings:e,values:[]}}}Tn.directiveName="unsafeHTML",Tn.resultType=1;const Pn=(t=>(...e)=>({_$litDirective$:t,values:e}))(Tn),Un="",kn="",Hn="",Nn="#f3f3f3",Rn="black",Mn=!1,Ln=!1,On="";class zn extends bn{constructor(){super(...arguments),this.hl=Un,this.italic=kn,this.bold=Hn,this.bgColor=Nn,this.fgColor=Rn,this.lang=On,this.lineNrs=Mn,this.noTrim=Ln,this.highlight=Un,this.codeHtml=""}_getMarkupLinesFromString(){const t=(t,e=0)=>[...Array(t).keys()].map((t=>t+e)),e=e=>{const i=[];if(e){const s=e.split(",");for(const e of s){const s=Number(e.trim());if(Number.isNaN(s)){const s=e.split("-");if(2===s.length){const e=Number(s[0].trim()),o=Number(s[1].trim());Number.isNaN(e)||Number.isNaN(o)||i.push(...t(o-e+1,e))}}else i.push(s)}}return i};return{hlLinesArr:e(this.hl),boldLinesArr:e(this.bold),italicLinesArr:e(this.italic)}}handleSlotChange(t){const e=t.target.assignedNodes({flatten:!0})[0];if(!e.textContent)return;let i=e.textContent;this.childNodes.length>1&&(i=this.innerHTML,i=i.replace(/</g,"&lt;"),i=i.replace(/>/g,"&gt;"));const s=i.replace(/^\n|\n$/g,"").split("\n");let o=0;const r=s[0].split(" ");for(const t of r){if(""!==t)break;o++}0!==s[s.length-1].trim().length||this.noTrim||s.pop();const n=this._getMarkupLinesFromString(),l=[];for(const[t,e]of s.entries()){const i=e.slice(o);let s="";this.lineNrs&&(s=`<span class="line-nr">${t+1}</span>`),"!!!"===e.substring(o,o+3)?l.push(`<code class="code-hl">${s}${i.slice(3)}</code>`):n.hlLinesArr.includes(t+1)?l.push(`<code class="code-hl">${s}${i}</code>`):"!!"===e.substring(o,o+2)?l.push(`<code class="code-bold">${s}${i.slice(2)}</code>`):n.boldLinesArr.includes(t+1)?l.push(`<code class="code-bold">${s}${i}</code>`):"!"===e.substring(o,o+1)?l.push(`<code class="code-italic">${s}${i.slice(1)}</code>`):n.italicLinesArr.includes(t+1)?l.push(`<code class="code-italic">${s}${i}</code>`):l.push(`<code>${s}${i}</code>`)}this.codeHtml=l.join("\n"),this.bgColor&&this.style.setProperty("--color-bg",this.bgColor),this.fgColor&&this.style.setProperty("--color-fg",this.fgColor)}async firstUpdated(){}render(){return this.highlight&&(this.hl=this.highlight),sn`
      <slot style="display:none;" @slotchange="${this.handleSlotChange}"></slot>
      <div class="code-container">
        <div class="lang">${this.lang}</div>
        ${Pn(`<pre class="codeblock">${this.codeHtml}</pre>`)}
      </div>
    `}}zn.styles=((t,...e)=>{const i=1===t.length?t[0]:e.reduce(((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1]),t[0]);return new Pr(i,xr)})`
    :host {
  ...
  `,Er([En({type:String,attribute:"hl"})],zn.prototype,"hl",void 0),Er([En({type:String,attribute:"italic"})],zn.prototype,"italic",void 0),Er([En({type:String,attribute:"bold"})],zn.prototype,"bold",void 0),Er([En({type:String,attribute:"bg-color"})],zn.prototype,"bgColor",void 0),Er([En({type:String,attribute:"fg-color"})],zn.prototype,"fgColor",void 0),Er([En({type:String,attribute:"lang"})],zn.prototype,"lang",void 0),Er([En({type:Boolean,attribute:"line-nrs"})],zn.prototype,"lineNrs",void 0),Er([En({type:Boolean,attribute:"no-trim"})],zn.prototype,"noTrim",void 0),Er([En({type:String,attribute:"highlight"})],zn.prototype,"highlight",void 0),Er([En({type:String})],zn.prototype,"codeHtml",void 0),window.customElements.define("dd-code",zn);
